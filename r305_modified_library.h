...
class Adafruit_Fingerprint {
 public:
  ...
  uint8_t downloadimage(uint16_t id);		//this method will download the image file from upper host computer
  uint8_t uploadimage(uint16_t id); 		//this method will upload the image file to upper host computer
